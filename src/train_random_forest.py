...
======================
Training model Random Forest Classifier untuk klasifikasi tingkat obesitas.
...
def train_random_forest(X_train_sc, y_train, X_test_sc, y_test,
                         n_estimators: int = 100) -> dict:
    """
    Melatih model Random Forest dan mengembalikan dict hasil metrik.
    ...
    y_test       : array-like
    n_estimators : int — jumlah pohon dalam hutan
...
def main():
    ...
    result = train_random_forest(X_train_sc, y_train, X_test_sc, y_test)
