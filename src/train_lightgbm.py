...
train_lightgbm.py
=================
Training model LightGBM Classifier untuk klasifikasi tingkat obesitas.
...
def train_lightgbm(X_train_sc, y_train, X_test_sc, y_test,
    ...
    """
    Melatih model LightGBM dan mengembalikan dict hasil metrik.
    ...
    num_leaves    : int   — jumlah daun per pohon
    ...
    print("  ⏳ LightGBM ~1-2 menit, harap tunggu ...")
...
def main():
    ...
    result = train_lightgbm(X_train_sc, y_train, X_test_sc, y_test)

    model_path = os.path.join(MODELS_DIR, "lightgbm.joblib")
    joblib.dump(result["model"], model_path)
    print(f"\n✓ Model LightGBM disimpan ke: {model_path}")
